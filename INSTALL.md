...
5. Rename the extracted folder from `super-healthcare-wellness-main` to `super-healthcare-wellness`.
6. Copy the renamed `super-healthcare-wellness` folder into your agent's skills directory.
...
This repository is the `super-healthcare-wellness` skill. Keep the full `super-healthcare-wellness` folder together when installing it.
